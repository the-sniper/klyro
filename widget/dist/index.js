"use strict";var N=(Y,k,b)=>new Promise((v,M)=>{var f=i=>{try{h(b.next(i))}catch(y){M(y)}},e=i=>{try{h(b.throw(i))}catch(y){M(y)}},h=i=>i.done?v(i.value):Promise.resolve(i.value).then(f,e);h((b=b.apply(Y,k)).next())});(function(){"use strict";let Y="2.3.3",k=null,b="",v="",M={init:f};function f(){return N(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),k=o.key||o.widgetKey,!k){console.error("[Klyro] Missing widget key in initKlyro");return}b=o.apiBase||"https://klyro-pro.vercel.app",v=`klyro_${k}`,console.log("[Klyro] Initializing with version:",Y),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",J):J()})}let e=null,h=!1,i=[],y=null,m=!1,E=null,R=null,D=!1,w=!1;function W(){try{let o=localStorage.getItem(v);if(o){let r=JSON.parse(o);return i=r.messages||[],y=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",i.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function j(){try{let o={messages:i,sessionId:y,lastUpdated:new Date().toISOString()};localStorage.setItem(v,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function Z(){try{localStorage.removeItem(v)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function q(){if(i.length===0)return;let o=(e==null?void 0:e.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),t=`${o}
`;t+=`Downloaded: ${r}
`,t+="=".repeat(50)+`

`,i.forEach((p,c)=>{let l=p.role==="user"?"You":(e==null?void 0:e.headerTitle)||"Assistant";t+=`${l}:
${p.content}
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function H(o){if(!o||o.length===0)return!0;let r=window.location.pathname;for(let t of o){let n=t.trim();if(n===r)return!0;if(n.endsWith("/*")){let a=n.slice(0,-2);if(r===a||r.startsWith(a+"/"))return!0}if(n==="/"&&r==="/")return!0}return!1}function F(){if(!E||!e)return;let o=window.location.pathname;if(o===R)return;if(R=o,H(e.allowedRoutes))E.style.display="",console.log("[Klyro] Widget shown on route:",o);else{if(E.style.display="none",h){h=!1;let t=E.querySelector(".klyro-panel");t&&t.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",o)}}function to(){R=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),F()});let o=history.pushState;history.pushState=function(...t){o.apply(this,t),console.log("[Klyro] PushState detected"),setTimeout(F,0)};let r=history.replaceState;history.replaceState=function(...t){r.apply(this,t),console.log("[Klyro] ReplaceState detected"),setTimeout(F,0)},console.log("[Klyro] Route change listeners set up")}function J(){return N(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",b);try{let o=`${b}/api/widget/${k}`;console.log("[Klyro] Fetching config from:",o);let r=yield fetch(o);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");e=yield r.json(),console.log("[Klyro] Config loaded:",e),W(),i.length>0&&e.welcomeMessage&&i[0].role==="assistant"&&i[0].content===e.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),i.shift(),j()),ro(),to(),!H(e.allowedRoutes)&&E&&(E.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(o){console.error("Klyro: Failed to load widget",o)}})}function ro(){console.log("[Klyro] Rendering widget...");let o=document.createElement("style");o.textContent=O,document.head.appendChild(o);let r=e.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let t=document.createElement("div");t.className=`klyro-widget ${r}`,t.style.setProperty("--primary-color",e.primaryColor);let n=e.launcherMode==="text"&&e.launcherText,a=e.logoUrl?`<img src="${B(e.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:eo;t.innerHTML=`
    ...
    `,document.body.appendChild(t),E=t;let g=t.querySelector(".klyro-button"),p=t.querySelector(".klyro-panel"),c=t.querySelector(".klyro-messages"),l=t.querySelector(".klyro-input"),A=t.querySelector(".klyro-send"),u=t.querySelector(".reset-btn"),G=t.querySelector(".klyro-header"),io=t.querySelector(".menu-btn"),C=t.querySelector(".klyro-menu-popover"),L=t.querySelector(".expand-toggle-btn"),X=t.querySelector(".download-transcript-btn"),I=t.querySelector(".klyro-popover-overlay"),no=I.querySelector(".confirm"),lo=I.querySelector(".cancel");x(),g.addEventListener("click",()=>{h=!h,p.classList.toggle("open",h);let s=e.launcherMode==="text"&&e.launcherText;h?(g.innerHTML=V,g.classList.remove("text-mode"),l.focus(),x()):(g.innerHTML=S+(s?`<span class="klyro-button-text">${B(e.launcherText)}</span>`:""),s&&g.classList.add("text-mode"))}),u.addEventListener("click",()=>{w=!1,C.classList.remove("open"),I.classList.add("open")}),io.addEventListener("click",s=>{s.stopPropagation(),w=!w,C.classList.toggle("open",w)}),document.addEventListener("click",()=>{w&&(w=!1,C.classList.remove("open"))}),L.addEventListener("click",()=>{D=!D,p.classList.toggle("expanded",D);let s=L.querySelector(".klyro-menu-item-icon"),d=L.querySelector(".klyro-menu-item-text");D?(s.innerHTML=oo,d.textContent="Collapse window"):(s.innerHTML=U,d.textContent="Expand window"),w=!1,C.classList.remove("open")}),X.addEventListener("click",()=>{q(),w=!1,C.classList.remove("open")}),lo.addEventListener("click",()=>{I.classList.remove("open")}),no.addEventListener("click",()=>{i=[],y=null,Z(),x(),I.classList.remove("open")});function K(s){return N(this,null,function*(){let d=s||l.value.trim();if(!(!d||m)){i.push({role:"user",content:d}),s||(l.value=""),x(),j(),m=!0,x();try{let Q=yield fetch(`${b}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:d,widgetKey:k,sessionId:y})}),T=yield Q.json();m=!1,Q.ok?(y=T.sessionId,i.push({role:"assistant",content:T.response}),j()):i.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(Q){m=!1,i.push({role:"assistant",content:"Unable to connect. Please try again later."})}x()}})}A.addEventListener("click",()=>K()),l.addEventListener("keypress",s=>{s.key==="Enter"&&K()});function x(){let s=i.filter((d,Q)=>!(Q===0&&d.role==="assistant"&&e.welcomeMessage&&d.content.trim()===e.welcomeMessage.trim()));s.length>0?G.classList.add("chat-active"):G.classList.remove("chat-active"),X.disabled=s.length===0,s.length===0?c.innerHTML=`
        ...
        `:c.innerHTML=s.map(d=>`
          <div class="klyro-message ${d.role}" ${d.role==="user"?`style="background: ${e.primaryColor}"`:""}>
            ${d.role==="assistant"?ao(d.content):B(d.content)}
          </div>
        `).join(""),m&&(c.innerHTML+=`
        ...
        `),c.scrollTop=c.scrollHeight,A.disabled=m}}function ao(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],t=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(l,A,u)=>{let G=`__LINK_${r.length}__`;return r.push({text:A,url:u}),G}),n=[];t=t.replace(/(https?:\/\/[^\s<\]]+)/g,(l,A)=>{if(l.includes("__LINK_"))return l;console.log("[Klyro] Found raw URL:",A);let u=`__URL_${n.length}__`;return n.push(A),u});let a=B(t);r.forEach((l,A)=>{let u=B(l.text);a=a.replace(`__LINK_${A}__`,`<a href="${l.url}" target="_blank" rel="noopener noreferrer">${u}</a>`)}),n.forEach((l,A)=>{a=a.replace(`__URL_${A}__`,`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`)}),a=a.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),a=a.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=a.split(`
`),p=!1,c=[];for(let l=0;l<g.length;l++){let A=g[l],u=A.match(/^[\s]*[•\-\*]\s+(.+)$/);u?(p||(c.push("<ul>"),p=!0),c.push(`<li>${u[1]}</li>`)):(p&&(c.push("</ul>"),p=!1),c.push(A))}return p&&c.push("</ul>"),a=c.join(`
`),a=a.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),a=a.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",a.substring(0,100)),a}function B(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),t=o.getAttribute("data-api-base");if(r){let n=t;if(!n&&o.src)try{let a=new URL(o.src);!a.hostname.includes("unpkg.com")&&!a.hostname.includes("jsdelivr.net")&&(n=a.origin)}catch(a){n=o.src.replace("/widget.js",""),(n==="widget.js"||n==="")&&(n=window.location.origin)}f({key:r,apiBase:n})}}}typeof module!="undefined"&&module.exports?module.exports={initKlyro:f}:window.initKlyro=f})();
