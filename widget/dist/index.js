"use strict";var j=(K,D,v)=>new Promise((G,X)=>{var N=s=>{try{m(v.next(s))}catch(B){X(B)}},t=s=>{try{m(v.throw(s))}catch(B){X(B)}},m=s=>s.done?G(s.value):Promise.resolve(s.value).then(N,t);m((v=v.apply(K,D)).next())});(function(){"use strict";let K="3.0.0",D=null,v="",G="",X={init:N};function N(){return j(this,arguments,function*(e={}){if(typeof e=="string"&&(e={key:e}),D=e.key||e.widgetKey,!D){console.error("[Klyro] Missing widget key in initKlyro");return}v=e.apiBase||"https://klyro-pro.vercel.app",G=`klyro_${D}`,S=!!e.inline,M=e.container||null,console.log("[Klyro] Initializing with version:",K),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$):$()})}let t=null,m=!1,s=[],B=null,C=!1,Q=null,T=null,F=!1,I=!1,S=!1,M=null,W=null;function ne(){try{let e=localStorage.getItem(G);if(e){let n=JSON.parse(e);return s=n.messages||[],B=n.sessionId||null,s.forEach(o=>{delete o.streaming}),console.log("[Klyro] Loaded persisted chat:",s.length,"messages"),!0}}catch(e){console.error("[Klyro] Failed to load persisted chat:",e)}return!1}function L(){try{let e={messages:s,sessionId:B,lastUpdated:new Date().toISOString()};localStorage.setItem(G,JSON.stringify(e))}catch(e){console.error("[Klyro] Failed to persist chat:",e)}}function ie(){try{localStorage.removeItem(G)}catch(e){console.error("[Klyro] Failed to clear persisted chat:",e)}}function ae(){if(s.length===0)return;let e=(t==null?void 0:t.headerTitle)||"Chat Transcript",n=new Date().toLocaleString(),o=`${e}
`;o+=`Downloaded: ${n}
`,o+="=".repeat(50)+`

`,s.forEach((w,A)=>{let g=w.role==="user"?"You":(t==null?void 0:t.headerTitle)||"Assistant";o+=`${g}:
${w.content}

`});let d=new Blob([o],{type:"text/plain"}),a=URL.createObjectURL(d),h=document.createElement("a");h.href=a,h.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(h),h.click(),document.body.removeChild(h),URL.revokeObjectURL(a)}let se=`
    .klyro-widget * {
  ...
  `,P=`<svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,le='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',de='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>',ve='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg>',ge='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',ce='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',Ae='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',Ce='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m15 3 6 6-6 6M9 21l-6-6 6-6"/></svg>',Ie='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6 6-6M6 9l6 6-6 6"/></svg>',z='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',pe='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>',ue=`<svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function _(e){if(!e||e.length===0)return!0;let n=window.location.pathname;for(let o of e){let d=o.trim();if(d===n)return!0;if(d.endsWith("/*")){let a=d.slice(0,-2);if(n===a||n.startsWith(a+"/"))return!0}if(d==="/"&&n==="/")return!0}return!1}function Z(){if(!Q||!t)return;let e=window.location.pathname;if(e===T)return;if(T=e,_(t.allowedRoutes))Q.style.display="",console.log("[Klyro] Widget shown on route:",e);else{if(Q.style.display="none",m){m=!1;let o=Q.querySelector(".klyro-panel");o&&o.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",e)}}function he(){T=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),Z()});let e=history.pushState;history.pushState=function(...o){e.apply(this,o),console.log("[Klyro] PushState detected"),setTimeout(Z,0)};let n=history.replaceState;history.replaceState=function(...o){n.apply(this,o),console.log("[Klyro] ReplaceState detected"),setTimeout(Z,0)},console.log("[Klyro] Route change listeners set up")}function $(){return j(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",v);try{let e=`${v}/api/widget/${D}`;console.log("[Klyro] Fetching config from:",e);let n=yield fetch(e);if(console.log("[Klyro] Response status:",n.status),!n.ok)throw new Error("Widget not found");t=yield n.json(),console.log("[Klyro] Config loaded:",t),ne(),s.length>0&&t.welcomeMessage&&s[0].role==="assistant"&&s[0].content===t.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),s.shift(),L()),ye(),he(),!_(t.allowedRoutes)&&Q&&(Q.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(e){console.error("Klyro: Failed to load widget",e)}})}function ye(){console.log("[Klyro] Rendering widget...");let e=document.createElement("style");e.textContent=se,document.head.appendChild(e);let n=t.theme;n==="auto"&&(n=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let o=document.createElement("div");o.className=`klyro-widget ${n}${S?" klyro-inline":""}`,o.style.setProperty("--primary-color",t.primaryColor);let d=t.launcherMode==="text"&&t.launcherText,a=t.logoUrl?`<img src="${u(t.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:ue;if(o.innerHTML=`
      ...
      <div class="klyro-panel ${t.position}">
        ...
        <div class="klyro-input-area">
          <div class="klyro-input-container">
            ...
            <button class="klyro-send" style="background: ${t.primaryColor}">${de}</button>
          </div>
        </div>
    ...
    `,S&&M){let r=typeof M=="string"?document.querySelector(M):M;r?(r.style.position="relative",r.appendChild(o)):document.body.appendChild(o)}else document.body.appendChild(o);Q=o;let h=o.querySelector(".klyro-button"),w=o.querySelector(".klyro-panel"),A=o.querySelector(".klyro-messages"),g=o.querySelector(".klyro-input"),y=o.querySelector(".klyro-send"),x=o.querySelector(".reset-btn"),H=o.querySelector(".klyro-header"),be=o.querySelector(".menu-btn"),Y=o.querySelector(".klyro-menu-popover"),q=o.querySelector(".expand-toggle-btn"),te=o.querySelector(".download-transcript-btn"),R=o.querySelector(".klyro-popover-overlay"),ke=R.querySelector(".confirm"),fe=R.querySelector(".cancel");E(),S&&(m=!0,w.classList.add("open")),W=O,h.addEventListener("click",()=>{m=!m,w.classList.toggle("open",m);let r=t.launcherMode==="text"&&t.launcherText;m?(h.innerHTML=le,h.classList.remove("text-mode"),g.focus(),E()):(h.innerHTML=P+(r?`<span class="klyro-button-text">${u(t.launcherText)}</span>`:""),r&&h.classList.add("text-mode"))}),x.addEventListener("click",()=>{I=!1,Y.classList.remove("open"),R.classList.add("open")}),be.addEventListener("click",r=>{r.stopPropagation(),I=!I,Y.classList.toggle("open",I)}),document.addEventListener("click",()=>{I&&(I=!1,Y.classList.remove("open"))}),q.addEventListener("click",()=>{F=!F,w.classList.toggle("expanded",F);let r=q.querySelector(".klyro-menu-item-icon"),c=q.querySelector(".klyro-menu-item-text");F?(r.innerHTML=pe,c.textContent="Collapse window"):(r.innerHTML=z,c.textContent="Expand window"),I=!1,Y.classList.remove("open")}),te.addEventListener("click",()=>{ae(),I=!1,Y.classList.remove("open")}),fe.addEventListener("click",()=>{R.classList.remove("open")}),ke.addEventListener("click",()=>{s=[],B=null,ie(),E(),R.classList.remove("open")});function we(r){let c=A.querySelector(".klyro-message.streaming");c?c.innerHTML=ee(r.content):E()}function me(r){return j(this,null,function*(){let c=r.body.getReader(),i=new TextDecoder,l="",k=null,p=!1,U=()=>k||(C=!1,k={role:"assistant",content:"",sources:[],streaming:!0},s.push(k),E(),k),xe=b=>{if(b.type==="token"){let f=U();f.content+=b.text||"",we(f)}else if(b.type==="sources"){let f=U();f.sources=Array.isArray(b.sources)?b.sources:[]}else if(b.type==="done"){let f=U();f.streaming=!1,b.sessionId&&(B=b.sessionId),b.messageId&&(f.messageId=b.messageId),p=!0}else if(b.type==="error"){let f=U();f.streaming=!1,f.content||(f.content=b.message||"Sorry, I encountered an error. Please try again."),p=!0}};for(;;){let{done:b,value:f}=yield c.read();if(b)break;l+=i.decode(f,{stream:!0});let J=l.indexOf(`

`);for(;J!==-1;){let Ee=l.slice(0,J);l=l.slice(J+2),J=l.indexOf(`

`);for(let re of Ee.split(`
`)){if(!re.startsWith("data:"))continue;let V=re.slice(5).trim();if(V)try{xe(JSON.parse(V))}catch(De){console.warn("[Klyro] Ignoring malformed stream frame:",V)}}}}return k&&(k.streaming=!1,k.content||(k.content="Sorry, I encountered an error. Please try again."),L(),E()),p||k!==null})}function O(r){return j(this,null,function*(){let c=r||g.value.trim();if(!(!c||C)){s.push({role:"user",content:c}),r||(g.value=""),E(),L(),C=!0,E();try{let i=yield fetch(`${v}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify({message:c,widgetKey:D,sessionId:B,stream:!0})}),l=i.headers.get("content-type")||"";if(i.ok&&l.indexOf("text/event-stream")!==-1&&i.body&&typeof i.body.getReader=="function"){let p=yield me(i);if(C=!1,p)return}else{let p=yield i.json();C=!1,i.ok?(B=p.sessionId,s.push({role:"assistant",content:p.response,sources:Array.isArray(p.sources)?p.sources:[]}),L()):s.push({role:"assistant",content:p&&p.error?p.error:"Sorry, I encountered an error. Please try again."})}}catch(i){C=!1,s.push({role:"assistant",content:"Unable to connect. Please try again later."})}E()}})}y.addEventListener("click",()=>O()),g.addEventListener("keypress",r=>{r.key==="Enter"&&O()}),A.addEventListener("click",r=>{let c=r.target&&r.target.closest?r.target.closest(".klyro-sources-toggle"):null;if(!c)return;let i=parseInt(c.getAttribute("data-sources-index"),10),l=s[i];l&&(l.sourcesOpen=!l.sourcesOpen,E())});function Be(r,c){if(r.role!=="assistant"||r.streaming)return"";let i=Array.isArray(r.sources)?r.sources:[];if(i.length===0)return"";let l=!!r.sourcesOpen,k=i.map(p=>`
        ...
        </div>`}function E(){let r=s.map((i,l)=>({msg:i,index:l})).filter(({msg:i,index:l})=>!(l===0&&i.role==="assistant"&&t.welcomeMessage&&i.content.trim()===t.welcomeMessage.trim()));r.length>0?H.classList.add("chat-active"):H.classList.remove("chat-active"),te.disabled=r.length===0,r.length===0?A.innerHTML=`
        ...
        `:A.innerHTML=r.map(({msg:i,index:l})=>`
          <div class="klyro-message ${i.role}${i.streaming?" streaming":""}" ${i.role==="user"?`style="background: ${t.primaryColor}"`:""}>
            ${i.role==="assistant"?ee(i.content):u(i.content)}
          </div>
          ${Be(i,l)}
        `).join(""),C&&(A.innerHTML+=`
        ...
        `);let c=r;if(!C&&c.length>0)if(c[c.length-1].msg.role==="assistant"){let l=A.lastElementChild;l&&(A.scrollTop=l.offsetTop-20)}else A.scrollTop=A.scrollHeight;else A.scrollTop=A.scrollHeight;y.disabled=C}}function ee(e){if(!e)return"";console.log("[Klyro] formatMessage called with:",e.substring(0,100));let n=[],o=e.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(g,y,x)=>{let H=`__LINK_${n.length}__`;return n.push({text:y,url:x}),H}),d=[];o=o.replace(/(https?:\/\/[^\s<\]]+)/g,(g,y)=>{if(g.includes("__LINK_"))return g;console.log("[Klyro] Found raw URL:",y);let x=`__URL_${d.length}__`;return d.push(y),x});let a=u(o);n.forEach((g,y)=>{let x=u(g.text);a=a.replace(`__LINK_${y}__`,`<a href="${g.url}" target="_blank" rel="noopener noreferrer">${x}</a>`)}),d.forEach((g,y)=>{a=a.replace(`__URL_${y}__`,`<a href="${g}" target="_blank" rel="noopener noreferrer">${g}</a>`)}),a=a.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),a=a.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let h=a.split(`
`),w=!1,A=[];for(let g=0;g<h.length;g++){let y=h[g],x=y.match(/^[\s]*[•\-\*]\s+(.+)$/);x?(w||(A.push("<ul>"),w=!0),A.push(`<li>${x[1]}</li>`)):(w&&(A.push("</ul>"),w=!1),A.push(y))}return w&&A.push("</ul>"),a=A.join(`
`),a=a.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),a=a.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",a.substring(0,100)),a}function u(e){if(typeof document=="undefined")return e;let n=document.createElement("div");return n.textContent=e,n.innerHTML}if(typeof document!="undefined"){let e=document.currentScript;if(e){let n=e.getAttribute("data-widget-key"),o=e.getAttribute("data-api-base");if(n){let d=o;if(!d&&e.src)try{let a=new URL(e.src);!a.hostname.includes("unpkg.com")&&!a.hostname.includes("jsdelivr.net")&&(d=a.origin)}catch(a){d=e.src.replace("/widget.js",""),(d==="widget.js"||d==="")&&(d=window.location.origin)}N({key:n,apiBase:d})}}}function oe(e){W&&W(e)}typeof module!="undefined"&&module.exports&&(module.exports={initKlyro:N,sendMessage:oe}),typeof window!="undefined"&&(window.initKlyro=N,window.klyroSendMessage=oe)})();
