"use strict";var R=(j,E,w)=>new Promise((C,F)=>{var x=n=>{try{h(w.next(n))}catch(B){F(B)}},t=n=>{try{h(w.throw(n))}catch(B){F(B)}},h=n=>n.done?C(n.value):Promise.resolve(n.value).then(x,t);h((w=w.apply(j,E)).next())});(function(){"use strict";let j="2.3.3",E=null,w="",C="",F={init:x};function x(){return R(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),E=o.key||o.widgetKey,!E){console.error("[Klyro] Missing widget key in initKlyro");return}w=o.apiBase||"https://klyro-pro.vercel.app",C=`klyro_${E}`,M=!!o.inline,D=o.container||null,console.log("[Klyro] Initializing with version:",j),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Z):Z()})}let t=null,h=!1,n=[],B=null,m=!1,f=null,L=null,N=!1,k=!1,M=!1,D=null,S=null;function V(){try{let o=localStorage.getItem(C);if(o){let r=JSON.parse(o);return n=r.messages||[],B=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",n.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function H(){try{let o={messages:n,sessionId:B,lastUpdated:new Date().toISOString()};localStorage.setItem(C,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function P(){try{localStorage.removeItem(C)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function z(){if(n.length===0)return;let o=(t==null?void 0:t.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),e=`${o}
`;e+=`Downloaded: ${r}
`,e+="=".repeat(50)+`

`,n.forEach((p,d)=>{let s=p.role==="user"?"You":(t==null?void 0:t.headerTitle)||"Assistant";e+=`${s}:
${p.content}

`});let l=new Blob([e],{type:"text/plain"}),i=URL.createObjectURL(l),g=document.createElement("a");g.href=i,g.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(i)}let _=`
    .klyro-widget * {
  ...
  `,K=`<svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,$='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',oo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>',po='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg>',eo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',to='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',ro='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',ho='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m15 3 6 6-6 6M9 21l-6-6 6-6"/></svg>',uo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6 6-6M6 9l6 6-6 6"/></svg>',T='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',io='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>',no=`<svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function W(o){if(!o||o.length===0)return!0;let r=window.location.pathname;for(let e of o){let l=e.trim();if(l===r)return!0;if(l.endsWith("/*")){let i=l.slice(0,-2);if(r===i||r.startsWith(i+"/"))return!0}if(l==="/"&&r==="/")return!0}return!1}function U(){if(!f||!t)return;let o=window.location.pathname;if(o===L)return;if(L=o,W(t.allowedRoutes))f.style.display="",console.log("[Klyro] Widget shown on route:",o);else{if(f.style.display="none",h){h=!1;let e=f.querySelector(".klyro-panel");e&&e.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",o)}}function ao(){L=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),U()});let o=history.pushState;history.pushState=function(...e){o.apply(this,e),console.log("[Klyro] PushState detected"),setTimeout(U,0)};let r=history.replaceState;history.replaceState=function(...e){r.apply(this,e),console.log("[Klyro] ReplaceState detected"),setTimeout(U,0)},console.log("[Klyro] Route change listeners set up")}function Z(){return R(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",w);try{let o=`${w}/api/widget/${E}`;console.log("[Klyro] Fetching config from:",o);let r=yield fetch(o);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");t=yield r.json(),console.log("[Klyro] Config loaded:",t),V(),n.length>0&&t.welcomeMessage&&n[0].role==="assistant"&&n[0].content===t.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),n.shift(),H()),lo(),ao(),!W(t.allowedRoutes)&&f&&(f.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(o){console.error("Klyro: Failed to load widget",o)}})}function lo(){console.log("[Klyro] Rendering widget...");let o=document.createElement("style");o.textContent=_,document.head.appendChild(o);let r=t.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let e=document.createElement("div");e.className=`klyro-widget ${r}${M?" klyro-inline":""}`,e.style.setProperty("--primary-color",t.primaryColor);let l=t.launcherMode==="text"&&t.launcherText,i=t.logoUrl?`<img src="${u(t.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:no;if(e.innerHTML=`
      <button class="klyro-button ${t.position} ${l?"text-mode":""}" style="background: ${t.primaryColor}; color: white;">
        ${K}
        ${l?`<span class="klyro-button-text">${u(t.launcherText)}</span>`:""}
      </button>
      <div class="klyro-panel ${t.position}">
        ...
        <div class="klyro-input-area">
          <div class="klyro-input-container">
            ...
            <button class="klyro-send" style="background: ${t.primaryColor}">${oo}</button>
          </div>
        </div>
    ...
    `,M&&D){let a=typeof D=="string"?document.querySelector(D):D;a?(a.style.position="relative",a.appendChild(e)):document.body.appendChild(e)}else document.body.appendChild(e);f=e;let g=e.querySelector(".klyro-button"),p=e.querySelector(".klyro-panel"),d=e.querySelector(".klyro-messages"),s=e.querySelector(".klyro-input"),c=e.querySelector(".klyro-send"),b=e.querySelector(".reset-btn"),Y=e.querySelector(".klyro-header"),go=e.querySelector(".menu-btn"),Q=e.querySelector(".klyro-menu-popover"),J=e.querySelector(".expand-toggle-btn"),O=e.querySelector(".download-transcript-btn"),G=e.querySelector(".klyro-popover-overlay"),co=G.querySelector(".confirm"),Ao=G.querySelector(".cancel");I(),M&&(h=!0,p.classList.add("open")),S=X,g.addEventListener("click",()=>{h=!h,p.classList.toggle("open",h);let a=t.launcherMode==="text"&&t.launcherText;h?(g.innerHTML=$,g.classList.remove("text-mode"),s.focus(),I()):(g.innerHTML=K+(a?`<span class="klyro-button-text">${u(t.launcherText)}</span>`:""),a&&g.classList.add("text-mode"))}),b.addEventListener("click",()=>{k=!1,Q.classList.remove("open"),G.classList.add("open")}),go.addEventListener("click",a=>{a.stopPropagation(),k=!k,Q.classList.toggle("open",k)}),document.addEventListener("click",()=>{k&&(k=!1,Q.classList.remove("open"))}),J.addEventListener("click",()=>{N=!N,p.classList.toggle("expanded",N);let a=J.querySelector(".klyro-menu-item-icon"),y=J.querySelector(".klyro-menu-item-text");N?(a.innerHTML=io,y.textContent="Collapse window"):(a.innerHTML=T,y.textContent="Expand window"),k=!1,Q.classList.remove("open")}),O.addEventListener("click",()=>{z(),k=!1,Q.classList.remove("open")}),Ao.addEventListener("click",()=>{G.classList.remove("open")}),co.addEventListener("click",()=>{n=[],B=null,P(),I(),G.classList.remove("open")});function X(a){return R(this,null,function*(){let y=a||s.value.trim();if(!(!y||m)){n.push({role:"user",content:y}),a||(s.value=""),I(),H(),m=!0,I();try{let A=yield fetch(`${w}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:y,widgetKey:E,sessionId:B})}),v=yield A.json();m=!1,A.ok?(B=v.sessionId,n.push({role:"assistant",content:v.response}),H()):n.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(A){m=!1,n.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}c.addEventListener("click",()=>X()),s.addEventListener("keypress",a=>{a.key==="Enter"&&X()});function I(){let a=n.filter((A,v)=>!(v===0&&A.role==="assistant"&&t.welcomeMessage&&A.content.trim()===t.welcomeMessage.trim()));a.length>0?Y.classList.add("chat-active"):Y.classList.remove("chat-active"),O.disabled=a.length===0,a.length===0?d.innerHTML=`
        ...
        `:d.innerHTML=a.map(A=>`
          <div class="klyro-message ${A.role}" ${A.role==="user"?`style="background: ${t.primaryColor}"`:""}>
            ${A.role==="assistant"?so(A.content):u(A.content)}
          </div>
        `).join(""),m&&(d.innerHTML+=`
        ...
        `);let y=a;if(!m&&y.length>0)if(y[y.length-1].role==="assistant"){let v=d.lastElementChild;v&&(d.scrollTop=v.offsetTop-20)}else d.scrollTop=d.scrollHeight;else d.scrollTop=d.scrollHeight;c.disabled=m}}function so(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],e=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(s,c,b)=>{let Y=`__LINK_${r.length}__`;return r.push({text:c,url:b}),Y}),l=[];e=e.replace(/(https?:\/\/[^\s<\]]+)/g,(s,c)=>{if(s.includes("__LINK_"))return s;console.log("[Klyro] Found raw URL:",c);let b=`__URL_${l.length}__`;return l.push(c),b});let i=u(e);r.forEach((s,c)=>{let b=u(s.text);i=i.replace(`__LINK_${c}__`,`<a href="${s.url}" target="_blank" rel="noopener noreferrer">${b}</a>`)}),l.forEach((s,c)=>{i=i.replace(`__URL_${c}__`,`<a href="${s}" target="_blank" rel="noopener noreferrer">${s}</a>`)}),i=i.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),i=i.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=i.split(`
`),p=!1,d=[];for(let s=0;s<g.length;s++){let c=g[s],b=c.match(/^[\s]*[•\-\*]\s+(.+)$/);b?(p||(d.push("<ul>"),p=!0),d.push(`<li>${b[1]}</li>`)):(p&&(d.push("</ul>"),p=!1),d.push(c))}return p&&d.push("</ul>"),i=d.join(`
`),i=i.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),i=i.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",i.substring(0,100)),i}function u(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),e=o.getAttribute("data-api-base");if(r){let l=e;if(!l&&o.src)try{let i=new URL(o.src);!i.hostname.includes("unpkg.com")&&!i.hostname.includes("jsdelivr.net")&&(l=i.origin)}catch(i){l=o.src.replace("/widget.js",""),(l==="widget.js"||l==="")&&(l=window.location.origin)}x({key:r,apiBase:l})}}}function q(o){S&&S(o)}typeof module!="undefined"&&module.exports?module.exports={initKlyro:x,sendMessage:q}:(window.initKlyro=x,window.klyroSendMessage=q)})();
