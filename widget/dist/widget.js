"use strict";(()=>{var go=(D,p)=>()=>(p||D((p={exports:{}}).exports,p),p.exports);var Y=(D,p,B)=>new Promise((m,j)=>{var x=a=>{try{u(B.next(a))}catch(k){j(k)}},e=a=>{try{u(B.throw(a))}catch(k){j(k)}},u=a=>a.done?m(a.value):Promise.resolve(a.value).then(x,e);u((B=B.apply(D,p)).next())});var co=go((bo,R)=>{(function(){"use strict";let D="2.3.3",p=null,B="",m="",j={init:x};function x(){return Y(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),p=o.key||o.widgetKey,!p){console.error("[Klyro] Missing widget key in initKlyro");return}B=o.apiBase||"https://klyro-pro.vercel.app",m=`klyro_${p}`,console.log("[Klyro] Initializing with version:",D),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",K):K()})}let e=null,u=!1,a=[],k=null,v=!1,f=null,F=null,N=!1,E=!1;function Z(){try{let o=localStorage.getItem(m);if(o){let r=JSON.parse(o);return a=r.messages||[],k=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",a.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function L(){try{let o={messages:a,sessionId:k,lastUpdated:new Date().toISOString()};localStorage.setItem(m,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function q(){try{localStorage.removeItem(m)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function O(){if(a.length===0)return;let o=(e==null?void 0:e.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),t=`${o}
`;t+=`Downloaded: ${r}
`,t+="=".repeat(50)+`
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
      ...
      <div class="klyro-panel ${e.position}">
        ...
        <div class="klyro-header">
          ...
          <div class="klyro-header-text">
            <h3>${b(e.headerTitle||"Chat Assistant")}</h3>
          </div>
    ...
    `,document.body.appendChild(t),f=t;let g=t.querySelector(".klyro-button"),h=t.querySelector(".klyro-panel"),d=t.querySelector(".klyro-messages"),l=t.querySelector(".klyro-input"),c=t.querySelector(".klyro-send"),y=t.querySelector(".reset-btn"),M=t.querySelector(".klyro-header"),no=t.querySelector(".menu-btn"),Q=t.querySelector(".klyro-menu-popover"),S=t.querySelector(".expand-toggle-btn"),T=t.querySelector(".download-transcript-btn"),G=t.querySelector(".klyro-popover-overlay"),lo=G.querySelector(".confirm"),so=G.querySelector(".cancel");I(),g.addEventListener("click",()=>{u=!u,h.classList.toggle("open",u);let s=e.launcherMode==="text"&&e.launcherText;u?(g.innerHTML=P,g.classList.remove("text-mode"),l.focus(),I()):(g.innerHTML=U+(s?`<span class="klyro-button-text">${b(e.launcherText)}</span>`:""),s&&g.classList.add("text-mode"))}),y.addEventListener("click",()=>{E=!1,Q.classList.remove("open"),G.classList.add("open")}),no.addEventListener("click",s=>{s.stopPropagation(),E=!E,Q.classList.toggle("open",E)}),document.addEventListener("click",()=>{E&&(E=!1,Q.classList.remove("open"))}),S.addEventListener("click",()=>{N=!N,h.classList.toggle("expanded",N);let s=S.querySelector(".klyro-menu-item-icon"),w=S.querySelector(".klyro-menu-item-text");N?(s.innerHTML=eo,w.textContent="Collapse window"):(s.innerHTML=J,w.textContent="Expand window"),E=!1,Q.classList.remove("open")}),T.addEventListener("click",()=>{O(),E=!1,Q.classList.remove("open")}),so.addEventListener("click",()=>{G.classList.remove("open")}),lo.addEventListener("click",()=>{a=[],k=null,q(),I(),G.classList.remove("open")});function W(s){return Y(this,null,function*(){let w=s||l.value.trim();if(!(!w||v)){a.push({role:"user",content:w}),s||(l.value=""),I(),L(),v=!0,I();try{let A=yield fetch(`${B}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:w,widgetKey:p,sessionId:k})}),C=yield A.json();v=!1,A.ok?(k=C.sessionId,a.push({role:"assistant",content:C.response}),L()):a.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(A){v=!1,a.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}c.addEventListener("click",()=>W()),l.addEventListener("keypress",s=>{s.key==="Enter"&&W()});function I(){let s=a.filter((A,C)=>!(C===0&&A.role==="assistant"&&e.welcomeMessage&&A.content.trim()===e.welcomeMessage.trim()));s.length>0?M.classList.add("chat-active"):M.classList.remove("chat-active"),T.disabled=s.length===0,s.length===0?d.innerHTML=`
          <div class="klyro-empty-state">
            <h1>${b(e.welcomeTitle||"Hey there!")}<span>${b(e.welcomeHeadline||"How can I help?")}</span></h1>
        ...
        `:d.innerHTML=s.map(A=>`
          <div class="klyro-message ${A.role}" ${A.role==="user"?`style="background: ${e.primaryColor}"`:""}>
            ${A.role==="assistant"?ao(A.content):b(A.content)}
          </div>
        `).join(""),v&&(d.innerHTML+=`
        ...
        `);let w=s;if(!v&&w.length>0)if(w[w.length-1].role==="assistant"){let C=d.lastElementChild;C&&(d.scrollTop=C.offsetTop-20)}else d.scrollTop=d.scrollHeight;else d.scrollTop=d.scrollHeight;c.disabled=v}}function ao(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],t=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(l,c,y)=>{let M=`__LINK_${r.length}__`;return r.push({text:c,url:y}),M}),n=[];t=t.replace(/(https?:\/\/[^\s<\]]+)/g,(l,c)=>{if(l.includes("__LINK_"))return l;console.log("[Klyro] Found raw URL:",c);let y=`__URL_${n.length}__`;return n.push(c),y});let i=b(t);r.forEach((l,c)=>{let y=b(l.text);i=i.replace(`__LINK_${c}__`,`<a href="${l.url}" target="_blank" rel="noopener noreferrer">${y}</a>`)}),n.forEach((l,c)=>{i=i.replace(`__URL_${c}__`,`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`)}),i=i.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),i=i.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=i.split(`
`),h=!1,d=[];for(let l=0;l<g.length;l++){let c=g[l],y=c.match(/^[\s]*[•\-\*]\s+(.+)$/);y?(h||(d.push("<ul>"),h=!0),d.push(`<li>${y[1]}</li>`)):(h&&(d.push("</ul>"),h=!1),d.push(c))}return h&&d.push("</ul>"),i=d.join(`
`),i=i.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),i=i.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",i.substring(0,100)),i}function b(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),t=o.getAttribute("data-api-base");if(r){let n=t;if(!n&&o.src)try{let i=new URL(o.src);!i.hostname.includes("unpkg.com")&&!i.hostname.includes("jsdelivr.net")&&(n=i.origin)}catch(i){n=o.src.replace("/widget.js",""),(n==="widget.js"||n==="")&&(n=window.location.origin)}x({key:r,apiBase:n})}}}typeof R!="undefined"&&R.exports?R.exports={initKlyro:x}:window.initKlyro=x})()});co();})();
