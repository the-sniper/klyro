"use strict";(()=>{var go=(D,p)=>()=>(p||D((p={exports:{}}).exports,p),p.exports);var Y=(D,p,w)=>new Promise((x,j)=>{var m=a=>{try{u(w.next(a))}catch(B){j(B)}},e=a=>{try{u(w.throw(a))}catch(B){j(B)}},u=a=>a.done?x(a.value):Promise.resolve(a.value).then(m,e);u((w=w.apply(D,p)).next())});var co=go((bo,R)=>{(function(){"use strict";let D="2.3.3",p=null,w="",x="",j={init:m};function m(){return Y(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),p=o.key||o.widgetKey,!p){console.error("[Klyro] Missing widget key in initKlyro");return}w=o.apiBase||"https://klyro-pro.vercel.app",x=`klyro_${p}`,console.log("[Klyro] Initializing with version:",D),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",K):K()})}let e=null,u=!1,a=[],B=null,v=!1,f=null,F=null,N=!1,E=!1;function Z(){try{let o=localStorage.getItem(x);if(o){let r=JSON.parse(o);return a=r.messages||[],B=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",a.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function L(){try{let o={messages:a,sessionId:B,lastUpdated:new Date().toISOString()};localStorage.setItem(x,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function q(){try{localStorage.removeItem(x)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function O(){if(a.length===0)return;let o=(e==null?void 0:e.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),t=`${o}
`;t+=`Downloaded: ${r}
`,t+="=".repeat(50)+`

`,a.forEach((h,d)=>{let l=h.role==="user"?"You":(e==null?void 0:e.headerTitle)||"Assistant";t+=`${l}:
${h.content}

`});let n=new Blob([t],{type:"text/plain"}),i=URL.createObjectURL(n),g=document.createElement("a");g.href=i,g.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(i)}let V=`
    .klyro-widget * {
  ...
  `,U=`<svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,P='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',z='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>',Ao='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg>',_='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',$='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',oo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',po='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m15 3 6 6-6 6M9 21l-6-6 6-6"/></svg>',ho='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6 6-6M6 9l6 6-6 6"/></svg>',J='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',eo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>',to=`<svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function X(o){if(!o||o.length===0)return!0;let r=window.location.pathname;for(let t of o){let n=t.trim();if(n===r)return!0;if(n.endsWith("/*")){let i=n.slice(0,-2);if(r===i||r.startsWith(i+"/"))return!0}if(n==="/"&&r==="/")return!0}return!1}function H(){if(!f||!e)return;let o=window.location.pathname;if(o===F)return;if(F=o,X(e.allowedRoutes))f.style.display="",console.log("[Klyro] Widget shown on route:",o);else{if(f.style.display="none",u){u=!1;let t=f.querySelector(".klyro-panel");t&&t.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",o)}}function ro(){F=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),H()});let o=history.pushState;history.pushState=function(...t){o.apply(this,t),console.log("[Klyro] PushState detected"),setTimeout(H,0)};let r=history.replaceState;history.replaceState=function(...t){r.apply(this,t),console.log("[Klyro] ReplaceState detected"),setTimeout(H,0)},console.log("[Klyro] Route change listeners set up")}function K(){return Y(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",w);try{let o=`${w}/api/widget/${p}`;console.log("[Klyro] Fetching config from:",o);let r=yield fetch(o);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");e=yield r.json(),console.log("[Klyro] Config loaded:",e),Z(),a.length>0&&e.welcomeMessage&&a[0].role==="assistant"&&a[0].content===e.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),a.shift(),L()),io(),ro(),!X(e.allowedRoutes)&&f&&(f.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(o){console.error("Klyro: Failed to load widget",o)}})}function io(){console.log("[Klyro] Rendering widget...");let o=document.createElement("style");o.textContent=V,document.head.appendChild(o);let r=e.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let t=document.createElement("div");t.className=`klyro-widget ${r}`,t.style.setProperty("--primary-color",e.primaryColor);let n=e.launcherMode==="text"&&e.launcherText,i=e.logoUrl?`<img src="${k(e.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:to;t.innerHTML=`
      <button class="klyro-button ${e.position} ${n?"text-mode":""}" style="background: ${e.primaryColor}; color: white;">
        ${U}
        ${n?`<span class="klyro-button-text">${k(e.launcherText)}</span>`:""}
      </button>
      <div class="klyro-panel ${e.position}">
        ...
        <div class="klyro-header">
          ...
          <div class="klyro-header-text">
            <h3>${k(e.headerTitle||"Chat Assistant")}</h3>
          </div>
            ...
            <div class="klyro-menu-container">
              ...
              <div class="klyro-menu-popover">
                <button class="klyro-menu-item expand-toggle-btn">
                  <span class="klyro-menu-item-icon">${J}</span>
        ...
        <div class="klyro-input-area">
          <div class="klyro-input-container">
            ...
            <button class="klyro-send" style="background: ${e.primaryColor}">${z}</button>
          </div>
        </div>
    ...
    `,document.body.appendChild(t),f=t;let g=t.querySelector(".klyro-button"),h=t.querySelector(".klyro-panel"),d=t.querySelector(".klyro-messages"),l=t.querySelector(".klyro-input"),c=t.querySelector(".klyro-send"),b=t.querySelector(".reset-btn"),M=t.querySelector(".klyro-header"),no=t.querySelector(".menu-btn"),Q=t.querySelector(".klyro-menu-popover"),S=t.querySelector(".expand-toggle-btn"),T=t.querySelector(".download-transcript-btn"),G=t.querySelector(".klyro-popover-overlay"),lo=G.querySelector(".confirm"),so=G.querySelector(".cancel");I(),g.addEventListener("click",()=>{u=!u,h.classList.toggle("open",u);let s=e.launcherMode==="text"&&e.launcherText;u?(g.innerHTML=P,g.classList.remove("text-mode"),l.focus(),I()):(g.innerHTML=U+(s?`<span class="klyro-button-text">${k(e.launcherText)}</span>`:""),s&&g.classList.add("text-mode"))}),b.addEventListener("click",()=>{E=!1,Q.classList.remove("open"),G.classList.add("open")}),no.addEventListener("click",s=>{s.stopPropagation(),E=!E,Q.classList.toggle("open",E)}),document.addEventListener("click",()=>{E&&(E=!1,Q.classList.remove("open"))}),S.addEventListener("click",()=>{N=!N,h.classList.toggle("expanded",N);let s=S.querySelector(".klyro-menu-item-icon"),y=S.querySelector(".klyro-menu-item-text");N?(s.innerHTML=eo,y.textContent="Collapse window"):(s.innerHTML=J,y.textContent="Expand window"),E=!1,Q.classList.remove("open")}),T.addEventListener("click",()=>{O(),E=!1,Q.classList.remove("open")}),so.addEventListener("click",()=>{G.classList.remove("open")}),lo.addEventListener("click",()=>{a=[],B=null,q(),I(),G.classList.remove("open")});function W(s){return Y(this,null,function*(){let y=s||l.value.trim();if(!(!y||v)){a.push({role:"user",content:y}),s||(l.value=""),I(),L(),v=!0,I();try{let A=yield fetch(`${w}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:y,widgetKey:p,sessionId:B})}),C=yield A.json();v=!1,A.ok?(B=C.sessionId,a.push({role:"assistant",content:C.response}),L()):a.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(A){v=!1,a.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}c.addEventListener("click",()=>W()),l.addEventListener("keypress",s=>{s.key==="Enter"&&W()});function I(){let s=a.filter((A,C)=>!(C===0&&A.role==="assistant"&&e.welcomeMessage&&A.content.trim()===e.welcomeMessage.trim()));s.length>0?M.classList.add("chat-active"):M.classList.remove("chat-active"),T.disabled=s.length===0,s.length===0?d.innerHTML=`
          <div class="klyro-empty-state">
            <h1>Hey there!<span>${k(e.welcomeHeadline||"How can I help?")}</span></h1>
            <p>${k(e.welcomeMessage||"I can help answer questions about my background and experience")}</p>
          </div>
        `:d.innerHTML=s.map(A=>`
          <div class="klyro-message ${A.role}" ${A.role==="user"?`style="background: ${e.primaryColor}"`:""}>
            ${A.role==="assistant"?ao(A.content):k(A.content)}
          </div>
        `).join(""),v&&(d.innerHTML+=`
        ...
        `);let y=s;if(!v&&y.length>0)if(y[y.length-1].role==="assistant"){let C=d.lastElementChild;C&&(d.scrollTop=C.offsetTop-20)}else d.scrollTop=d.scrollHeight;else d.scrollTop=d.scrollHeight;c.disabled=v}}function ao(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],t=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(l,c,b)=>{let M=`__LINK_${r.length}__`;return r.push({text:c,url:b}),M}),n=[];t=t.replace(/(https?:\/\/[^\s<\]]+)/g,(l,c)=>{if(l.includes("__LINK_"))return l;console.log("[Klyro] Found raw URL:",c);let b=`__URL_${n.length}__`;return n.push(c),b});let i=k(t);r.forEach((l,c)=>{let b=k(l.text);i=i.replace(`__LINK_${c}__`,`<a href="${l.url}" target="_blank" rel="noopener noreferrer">${b}</a>`)}),n.forEach((l,c)=>{i=i.replace(`__URL_${c}__`,`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`)}),i=i.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),i=i.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=i.split(`
`),h=!1,d=[];for(let l=0;l<g.length;l++){let c=g[l],b=c.match(/^[\s]*[•\-\*]\s+(.+)$/);b?(h||(d.push("<ul>"),h=!0),d.push(`<li>${b[1]}</li>`)):(h&&(d.push("</ul>"),h=!1),d.push(c))}return h&&d.push("</ul>"),i=d.join(`
`),i=i.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),i=i.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",i.substring(0,100)),i}function k(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),t=o.getAttribute("data-api-base");if(r){let n=t;if(!n&&o.src)try{let i=new URL(o.src);!i.hostname.includes("unpkg.com")&&!i.hostname.includes("jsdelivr.net")&&(n=i.origin)}catch(i){n=o.src.replace("/widget.js",""),(n==="widget.js"||n==="")&&(n=window.location.origin)}m({key:r,apiBase:n})}}}typeof R!="undefined"&&R.exports?R.exports={initKlyro:m}:window.initKlyro=m})()});co();})();
