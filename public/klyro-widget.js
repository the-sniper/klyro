"use strict";(()=>{var Ce=(M,w)=>()=>(w||M((w={exports:{}}).exports,w),w.exports);var F=(M,w,C)=>new Promise((G,T)=>{var N=a=>{try{k(C.next(a))}catch(B){T(B)}},t=a=>{try{k(C.throw(a))}catch(B){T(B)}},k=a=>a.done?G(a.value):Promise.resolve(a.value).then(N,t);k((C=C.apply(M,w)).next())});var xe=Ce((Me,X)=>{(function(){"use strict";let M="2.3.3",w=null,C="",G="",T={init:N};function N(){return F(this,arguments,function*(e={}){if(typeof e=="string"&&(e={key:e}),w=e.key||e.widgetKey,!w){console.error("[Klyro] Missing widget key in initKlyro");return}C=e.apiBase||"https://klyro-pro.vercel.app",G=`klyro_${w}`,L=!!e.inline,Y=e.container||null,console.log("[Klyro] Initializing with version:",M),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ee):ee()})}let t=null,k=!1,a=[],B=null,x=!1,Q=null,W=null,S=!1,D=!1,L=!1,Y=null,Z=null;function ie(){try{let e=localStorage.getItem(G);if(e){let r=JSON.parse(e);return a=r.messages||[],B=r.sessionId||null,a.forEach(o=>{delete o.streaming}),console.log("[Klyro] Loaded persisted chat:",a.length,"messages"),!0}}catch(e){console.error("[Klyro] Failed to load persisted chat:",e)}return!1}function H(){try{let e={messages:a,sessionId:B,lastUpdated:new Date().toISOString()};localStorage.setItem(G,JSON.stringify(e))}catch(e){console.error("[Klyro] Failed to persist chat:",e)}}function ae(){try{localStorage.removeItem(G)}catch(e){console.error("[Klyro] Failed to clear persisted chat:",e)}}function se(){if(a.length===0)return;let e=(t==null?void 0:t.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),o=`${e}
`;o+=`Downloaded: ${r}
`,o+="=".repeat(50)+`

`,a.forEach((f,g)=>{let d=f.role==="user"?"You":(t==null?void 0:t.headerTitle)||"Assistant";o+=`${d}:
${f.content}

`});let s=new Blob([o],{type:"text/plain"}),n=URL.createObjectURL(s),A=document.createElement("a");A.href=n,A.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(A),A.click(),document.body.removeChild(A),URL.revokeObjectURL(n)}let le=`
    .klyro-widget * {
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function $(e){if(!e||e.length===0)return!0;let r=window.location.pathname;for(let o of e){let s=o.trim();if(s===r)return!0;if(s.endsWith("/*")){let n=s.slice(0,-2);if(r===n||r.startsWith(n+"/"))return!0}if(s==="/"&&r==="/")return!0}return!1}function q(){if(!Q||!t)return;let e=window.location.pathname;if(e===W)return;if(W=e,$(t.allowedRoutes))Q.style.display="",console.log("[Klyro] Widget shown on route:",e);else{if(Q.style.display="none",k){k=!1;let o=Q.querySelector(".klyro-panel");o&&o.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",e)}}function ye(){W=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),q()});let e=history.pushState;history.pushState=function(...o){e.apply(this,o),console.log("[Klyro] PushState detected"),setTimeout(q,0)};let r=history.replaceState;history.replaceState=function(...o){r.apply(this,o),console.log("[Klyro] ReplaceState detected"),setTimeout(q,0)},console.log("[Klyro] Route change listeners set up")}function ee(){return F(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",C);try{let e=`${C}/api/widget/${w}`;console.log("[Klyro] Fetching config from:",e);let r=yield fetch(e);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");t=yield r.json(),console.log("[Klyro] Config loaded:",t),ie(),a.length>0&&t.welcomeMessage&&a[0].role==="assistant"&&a[0].content===t.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),a.shift(),H()),be(),ye(),!$(t.allowedRoutes)&&Q&&(Q.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(e){console.error("Klyro: Failed to load widget",e)}})}function be(){console.log("[Klyro] Rendering widget...");let e=document.createElement("style");e.textContent=le,document.head.appendChild(e);let r=t.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let o=document.createElement("div");o.className=`klyro-widget ${r}${L?" klyro-inline":""}`,o.style.setProperty("--primary-color",t.primaryColor);let s=t.launcherMode==="text"&&t.launcherText,n=t.logoUrl?`<img src="${E(t.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:ue;if(o.innerHTML=`
      <button class="klyro-button ${t.position} ${s?"text-mode":""}" style="background: ${t.primaryColor}; color: white;">
        ${z}
        ${s?`<span class="klyro-button-text">${E(t.launcherText)}</span>`:""}
      </button>
      <div class="klyro-panel ${t.position}">
        ...
        <div class="klyro-header">
          ...
          <div class="klyro-header-text">
            <h3>${E(t.headerTitle||"Chat Assistant")}</h3>
          </div>
    ...
    `,L&&Y){let i=typeof Y=="string"?document.querySelector(Y):Y;i?(i.style.position="relative",i.appendChild(o)):document.body.appendChild(o)}else document.body.appendChild(o);Q=o;let A=o.querySelector(".klyro-button"),f=o.querySelector(".klyro-panel"),g=o.querySelector(".klyro-messages"),d=o.querySelector(".klyro-input"),p=o.querySelector(".klyro-send"),v=o.querySelector(".reset-btn"),U=o.querySelector(".klyro-header"),we=o.querySelector(".menu-btn"),R=o.querySelector(".klyro-menu-popover"),O=o.querySelector(".expand-toggle-btn"),re=o.querySelector(".download-transcript-btn"),j=o.querySelector(".klyro-popover-overlay"),fe=j.querySelector(".confirm"),ke=j.querySelector(".cancel");I(),L&&(k=!0,f.classList.add("open")),Z=V,A.addEventListener("click",()=>{k=!k,f.classList.toggle("open",k);let i=t.launcherMode==="text"&&t.launcherText;k?(A.innerHTML=de,A.classList.remove("text-mode"),d.focus(),I()):(A.innerHTML=z+(i?`<span class="klyro-button-text">${E(t.launcherText)}</span>`:""),i&&A.classList.add("text-mode"))}),v.addEventListener("click",()=>{D=!1,R.classList.remove("open"),j.classList.add("open")}),we.addEventListener("click",i=>{i.stopPropagation(),D=!D,R.classList.toggle("open",D)}),document.addEventListener("click",()=>{D&&(D=!1,R.classList.remove("open"))}),O.addEventListener("click",()=>{S=!S,f.classList.toggle("expanded",S);let i=O.querySelector(".klyro-menu-item-icon"),c=O.querySelector(".klyro-menu-item-text");S?(i.innerHTML=he,c.textContent="Collapse window"):(i.innerHTML=_,c.textContent="Expand window"),D=!1,R.classList.remove("open")}),re.addEventListener("click",()=>{se(),D=!1,R.classList.remove("open")}),ke.addEventListener("click",()=>{j.classList.remove("open")}),fe.addEventListener("click",()=>{a=[],B=null,ae(),I(),j.classList.remove("open")});function me(i){let c=g.querySelector(".klyro-message.streaming");c?c.innerHTML=oe(i.content):I()}function Be(i){return F(this,null,function*(){let c=i.body.getReader(),l=new TextDecoder,u="",m=null,y=!1,J=()=>m||(x=!1,m={role:"assistant",content:"",sources:[],streaming:!0},a.push(m),I(),m),Ee=h=>{if(h.type==="token"){let b=J();b.content+=h.text||"",me(b)}else if(h.type==="sources"){let b=J();b.sources=Array.isArray(h.sources)?h.sources:[]}else if(h.type==="done"){let b=J();b.streaming=!1,h.sessionId&&(B=h.sessionId),h.messageId&&(b.messageId=h.messageId),y=!0}else if(h.type==="error"){let b=J();b.streaming=!1,b.content||(b.content=h.message||"Sorry, I encountered an error. Please try again."),y=!0}};for(;;){let{done:h,value:b}=yield c.read();if(h)break;u+=l.decode(b,{stream:!0});let K=u.indexOf(`

`);for(;K!==-1;){let ve=u.slice(0,K);u=u.slice(K+2),K=u.indexOf(`

`);for(let ne of ve.split(`
`)){if(!ne.startsWith("data:"))continue;let P=ne.slice(5).trim();if(P)try{Ee(JSON.parse(P))}catch(Ge){console.warn("[Klyro] Ignoring malformed stream frame:",P)}}}}return m&&(m.streaming=!1,m.content||(m.content="Sorry, I encountered an error. Please try again."),H(),I()),y||m!==null})}function V(i){return F(this,null,function*(){let c=i||d.value.trim();if(!(!c||x)){a.push({role:"user",content:c}),i||(d.value=""),I(),H(),x=!0,I();try{let l=yield fetch(`${C}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify({message:c,widgetKey:w,sessionId:B,stream:!0})}),u=l.headers.get("content-type")||"";if(l.ok&&u.indexOf("text/event-stream")!==-1&&l.body&&typeof l.body.getReader=="function"){let y=yield Be(l);if(x=!1,y)return}else{let y=yield l.json();x=!1,l.ok?(B=y.sessionId,a.push({role:"assistant",content:y.response,sources:Array.isArray(y.sources)?y.sources:[]}),H()):a.push({role:"assistant",content:y&&y.error?y.error:"Sorry, I encountered an error. Please try again."})}}catch(l){x=!1,a.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}p.addEventListener("click",()=>V()),d.addEventListener("keypress",i=>{i.key==="Enter"&&V()});function I(){let i=a.filter((l,u)=>!(u===0&&l.role==="assistant"&&t.welcomeMessage&&l.content.trim()===t.welcomeMessage.trim()));i.length>0?U.classList.add("chat-active"):U.classList.remove("chat-active"),re.disabled=i.length===0,i.length===0?g.innerHTML=`
          <div class="klyro-empty-state">
            <h1>${E(t.welcomeTitle||"Hey there!")}<span>${E(t.welcomeHeadline||"How can I help?")}</span></h1>
            <p>${E(t.welcomeMessage||"I can help answer questions about my background and experience")}</p>
          </div>
        `:g.innerHTML=i.map(l=>`
          <div class="klyro-message ${l.role}${l.streaming?" streaming":""}" ${l.role==="user"?`style="background: ${t.primaryColor}"`:""}>
            ${l.role==="assistant"?oe(l.content):E(l.content)}
          </div>
        `).join(""),x&&(g.innerHTML+=`
        ...
        `);let c=i;if(!x&&c.length>0)if(c[c.length-1].role==="assistant"){let u=g.lastElementChild;u&&(g.scrollTop=u.offsetTop-20)}else g.scrollTop=g.scrollHeight;else g.scrollTop=g.scrollHeight;p.disabled=x}}function oe(e){if(!e)return"";console.log("[Klyro] formatMessage called with:",e.substring(0,100));let r=[],o=e.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(d,p,v)=>{let U=`__LINK_${r.length}__`;return r.push({text:p,url:v}),U}),s=[];o=o.replace(/(https?:\/\/[^\s<\]]+)/g,(d,p)=>{if(d.includes("__LINK_"))return d;console.log("[Klyro] Found raw URL:",p);let v=`__URL_${s.length}__`;return s.push(p),v});let n=E(o);r.forEach((d,p)=>{let v=E(d.text);n=n.replace(`__LINK_${p}__`,`<a href="${d.url}" target="_blank" rel="noopener noreferrer">${v}</a>`)}),s.forEach((d,p)=>{n=n.replace(`__URL_${p}__`,`<a href="${d}" target="_blank" rel="noopener noreferrer">${d}</a>`)}),n=n.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),n=n.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let A=n.split(`
`),f=!1,g=[];for(let d=0;d<A.length;d++){let p=A[d],v=p.match(/^[\s]*[•\-\*]\s+(.+)$/);v?(f||(g.push("<ul>"),f=!0),g.push(`<li>${v[1]}</li>`)):(f&&(g.push("</ul>"),f=!1),g.push(p))}return f&&g.push("</ul>"),n=g.join(`
`),n=n.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),n=n.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",n.substring(0,100)),n}function E(e){if(typeof document=="undefined")return e;let r=document.createElement("div");return r.textContent=e,r.innerHTML}if(typeof document!="undefined"){let e=document.currentScript;if(e){let r=e.getAttribute("data-widget-key"),o=e.getAttribute("data-api-base");if(r){let s=o;if(!s&&e.src)try{let n=new URL(e.src);!n.hostname.includes("unpkg.com")&&!n.hostname.includes("jsdelivr.net")&&(s=n.origin)}catch(n){s=e.src.replace("/widget.js",""),(s==="widget.js"||s==="")&&(s=window.location.origin)}N({key:r,apiBase:s})}}}function te(e){Z&&Z(e)}typeof X!="undefined"&&X.exports?X.exports={initKlyro:N,sendMessage:te}:(window.initKlyro=N,window.klyroSendMessage=te)})()});xe();})();
