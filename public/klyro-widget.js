"use strict";(()=>{var ho=(D,p)=>()=>(p||D((p={exports:{}}).exports,p),p.exports);var j=(D,p,B)=>new Promise((C,L)=>{var x=n=>{try{u(B.next(n))}catch(k){L(k)}},t=n=>{try{u(B.throw(n))}catch(k){L(k)}},u=n=>n.done?C(n.value):Promise.resolve(n.value).then(x,t);u((B=B.apply(D,p)).next())});var uo=ho((ko,F)=>{(function(){"use strict";let D="2.3.3",p=null,B="",C="",L={init:x};function x(){return j(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),p=o.key||o.widgetKey,!p){console.error("[Klyro] Missing widget key in initKlyro");return}B=o.apiBase||"https://klyro-pro.vercel.app",C=`klyro_${p}`,Y=!!o.inline,Q=o.container||null,console.log("[Klyro] Initializing with version:",D),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",q):q()})}let t=null,u=!1,n=[],k=null,m=!1,f=null,S=null,M=!1,E=!1,Y=!1,Q=null,H=null;function P(){try{let o=localStorage.getItem(C);if(o){let r=JSON.parse(o);return n=r.messages||[],k=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",n.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function U(){try{let o={messages:n,sessionId:k,lastUpdated:new Date().toISOString()};localStorage.setItem(C,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function z(){try{localStorage.removeItem(C)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function _(){if(n.length===0)return;let o=(t==null?void 0:t.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),e=`${o}
`;e+=`Downloaded: ${r}
`,e+="=".repeat(50)+`

`,n.forEach((h,d)=>{let s=h.role==="user"?"You":(t==null?void 0:t.headerTitle)||"Assistant";e+=`${s}:
${h.content}

`});let l=new Blob([e],{type:"text/plain"}),i=URL.createObjectURL(l),g=document.createElement("a");g.href=i,g.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(i)}let $=`
    .klyro-widget * {
  ...
  `,T=`<svg width="61" height="61" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,oo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',eo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></svg>',bo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg>',to='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',ro='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>',io='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>',yo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m15 3 6 6-6 6M9 21l-6-6 6-6"/></svg>',wo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6 6-6M6 9l6 6-6 6"/></svg>',W='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>',no='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>',ao=`<svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function Z(o){if(!o||o.length===0)return!0;let r=window.location.pathname;for(let e of o){let l=e.trim();if(l===r)return!0;if(l.endsWith("/*")){let i=l.slice(0,-2);if(r===i||r.startsWith(i+"/"))return!0}if(l==="/"&&r==="/")return!0}return!1}function J(){if(!f||!t)return;let o=window.location.pathname;if(o===S)return;if(S=o,Z(t.allowedRoutes))f.style.display="",console.log("[Klyro] Widget shown on route:",o);else{if(f.style.display="none",u){u=!1;let e=f.querySelector(".klyro-panel");e&&e.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",o)}}function lo(){S=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),J()});let o=history.pushState;history.pushState=function(...e){o.apply(this,e),console.log("[Klyro] PushState detected"),setTimeout(J,0)};let r=history.replaceState;history.replaceState=function(...e){r.apply(this,e),console.log("[Klyro] ReplaceState detected"),setTimeout(J,0)},console.log("[Klyro] Route change listeners set up")}function q(){return j(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",B);try{let o=`${B}/api/widget/${p}`;console.log("[Klyro] Fetching config from:",o);let r=yield fetch(o);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");t=yield r.json(),console.log("[Klyro] Config loaded:",t),P(),n.length>0&&t.welcomeMessage&&n[0].role==="assistant"&&n[0].content===t.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),n.shift(),U()),so(),lo(),!Z(t.allowedRoutes)&&f&&(f.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(o){console.error("Klyro: Failed to load widget",o)}})}function so(){console.log("[Klyro] Rendering widget...");let o=document.createElement("style");o.textContent=$,document.head.appendChild(o);let r=t.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let e=document.createElement("div");e.className=`klyro-widget ${r}${Y?" klyro-inline":""}`,e.style.setProperty("--primary-color",t.primaryColor);let l=t.launcherMode==="text"&&t.launcherText,i=t.logoUrl?`<img src="${b(t.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:ao;if(e.innerHTML=`
      <button class="klyro-button ${t.position} ${l?"text-mode":""}" style="background: ${t.primaryColor}; color: white;">
        ${T}
        ${l?`<span class="klyro-button-text">${b(t.launcherText)}</span>`:""}
      </button>
      <div class="klyro-panel ${t.position}">
        ...
        <div class="klyro-header">
          <div class="klyro-header-icon">${i}</div>
        ...
        <div class="klyro-input-area">
          <div class="klyro-input-container">
            ...
            <button class="klyro-send" style="background: ${t.primaryColor}">${eo}</button>
          </div>
        </div>
    ...
    `,Y&&Q){let a=typeof Q=="string"?document.querySelector(Q):Q;a?(a.style.position="relative",a.appendChild(e)):document.body.appendChild(e)}else document.body.appendChild(e);f=e;let g=e.querySelector(".klyro-button"),h=e.querySelector(".klyro-panel"),d=e.querySelector(".klyro-messages"),s=e.querySelector(".klyro-input"),c=e.querySelector(".klyro-send"),y=e.querySelector(".reset-btn"),R=e.querySelector(".klyro-header"),co=e.querySelector(".menu-btn"),G=e.querySelector(".klyro-menu-popover"),X=e.querySelector(".expand-toggle-btn"),V=e.querySelector(".download-transcript-btn"),N=e.querySelector(".klyro-popover-overlay"),Ao=N.querySelector(".confirm"),po=N.querySelector(".cancel");I(),Y&&(u=!0,h.classList.add("open")),H=K,g.addEventListener("click",()=>{u=!u,h.classList.toggle("open",u);let a=t.launcherMode==="text"&&t.launcherText;u?(g.innerHTML=oo,g.classList.remove("text-mode"),s.focus(),I()):(g.innerHTML=T+(a?`<span class="klyro-button-text">${b(t.launcherText)}</span>`:""),a&&g.classList.add("text-mode"))}),y.addEventListener("click",()=>{E=!1,G.classList.remove("open"),N.classList.add("open")}),co.addEventListener("click",a=>{a.stopPropagation(),E=!E,G.classList.toggle("open",E)}),document.addEventListener("click",()=>{E&&(E=!1,G.classList.remove("open"))}),X.addEventListener("click",()=>{M=!M,h.classList.toggle("expanded",M);let a=X.querySelector(".klyro-menu-item-icon"),w=X.querySelector(".klyro-menu-item-text");M?(a.innerHTML=no,w.textContent="Collapse window"):(a.innerHTML=W,w.textContent="Expand window"),E=!1,G.classList.remove("open")}),V.addEventListener("click",()=>{_(),E=!1,G.classList.remove("open")}),po.addEventListener("click",()=>{N.classList.remove("open")}),Ao.addEventListener("click",()=>{n=[],k=null,z(),I(),N.classList.remove("open")});function K(a){return j(this,null,function*(){let w=a||s.value.trim();if(!(!w||m)){n.push({role:"user",content:w}),a||(s.value=""),I(),U(),m=!0,I();try{let A=yield fetch(`${B}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:w,widgetKey:p,sessionId:k})}),v=yield A.json();m=!1,A.ok?(k=v.sessionId,n.push({role:"assistant",content:v.response}),U()):n.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(A){m=!1,n.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}c.addEventListener("click",()=>K()),s.addEventListener("keypress",a=>{a.key==="Enter"&&K()});function I(){let a=n.filter((A,v)=>!(v===0&&A.role==="assistant"&&t.welcomeMessage&&A.content.trim()===t.welcomeMessage.trim()));a.length>0?R.classList.add("chat-active"):R.classList.remove("chat-active"),V.disabled=a.length===0,a.length===0?d.innerHTML=`
        ...
        `:d.innerHTML=a.map(A=>`
          <div class="klyro-message ${A.role}" ${A.role==="user"?`style="background: ${t.primaryColor}"`:""}>
            ${A.role==="assistant"?go(A.content):b(A.content)}
          </div>
        `).join(""),m&&(d.innerHTML+=`
        ...
        `);let w=a;if(!m&&w.length>0)if(w[w.length-1].role==="assistant"){let v=d.lastElementChild;v&&(d.scrollTop=v.offsetTop-20)}else d.scrollTop=d.scrollHeight;else d.scrollTop=d.scrollHeight;c.disabled=m}}function go(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],e=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(s,c,y)=>{let R=`__LINK_${r.length}__`;return r.push({text:c,url:y}),R}),l=[];e=e.replace(/(https?:\/\/[^\s<\]]+)/g,(s,c)=>{if(s.includes("__LINK_"))return s;console.log("[Klyro] Found raw URL:",c);let y=`__URL_${l.length}__`;return l.push(c),y});let i=b(e);r.forEach((s,c)=>{let y=b(s.text);i=i.replace(`__LINK_${c}__`,`<a href="${s.url}" target="_blank" rel="noopener noreferrer">${y}</a>`)}),l.forEach((s,c)=>{i=i.replace(`__URL_${c}__`,`<a href="${s}" target="_blank" rel="noopener noreferrer">${s}</a>`)}),i=i.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),i=i.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=i.split(`
`),h=!1,d=[];for(let s=0;s<g.length;s++){let c=g[s],y=c.match(/^[\s]*[•\-\*]\s+(.+)$/);y?(h||(d.push("<ul>"),h=!0),d.push(`<li>${y[1]}</li>`)):(h&&(d.push("</ul>"),h=!1),d.push(c))}return h&&d.push("</ul>"),i=d.join(`
`),i=i.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),i=i.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",i.substring(0,100)),i}function b(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),e=o.getAttribute("data-api-base");if(r){let l=e;if(!l&&o.src)try{let i=new URL(o.src);!i.hostname.includes("unpkg.com")&&!i.hostname.includes("jsdelivr.net")&&(l=i.origin)}catch(i){l=o.src.replace("/widget.js",""),(l==="widget.js"||l==="")&&(l=window.location.origin)}x({key:r,apiBase:l})}}}function O(o){H&&H(o)}typeof F!="undefined"&&F.exports?F.exports={initKlyro:x,sendMessage:O}:(window.initKlyro=x,window.klyroSendMessage=O)})()});uo();})();
