"use strict";(()=>{var j=(F,w,u)=>new Promise((m,x)=>{var o=A=>{try{n(u.next(A))}catch(b){x(b)}},k=A=>{try{n(u.throw(A))}catch(b){x(b)}},n=A=>A.done?m(A.value):Promise.resolve(A.value).then(o,k);n((u=u.apply(F,w)).next())});(function(){"use strict";console.log("[Klyro] Widget script loaded, version:","2.3.1");let w=document.currentScript,u=w==null?void 0:w.getAttribute("data-widget-key");if(console.log("[Klyro] Widget key:",u),!u){console.error("Klyro: Missing data-widget-key attribute");return}let m=(w==null?void 0:w.src.replace("/widget.js",""))||"",x=`klyro_${u}`,o=null,k=!1,n=[],A=null,b=!1,v=null,N=null,Q=!1,E=!1;function W(){try{let e=localStorage.getItem(x);if(e){let r=JSON.parse(e);return n=r.messages||[],A=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",n.length,"messages"),!0}}catch(e){console.error("[Klyro] Failed to load persisted chat:",e)}return!1}function Y(){try{let e={messages:n,sessionId:A,lastUpdated:new Date().toISOString()};localStorage.setItem(x,JSON.stringify(e))}catch(e){console.error("[Klyro] Failed to persist chat:",e)}}function T(){try{localStorage.removeItem(x)}catch(e){console.error("[Klyro] Failed to clear persisted chat:",e)}}function Z(){if(n.length===0)return;let e=(o==null?void 0:o.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),t=`${e}
`;t+=`Downloaded: ${r}
`,t+="=".repeat(50)+`
