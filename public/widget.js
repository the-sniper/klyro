"use strict";(()=>{var go=(D,p)=>()=>(p||D((p={exports:{}}).exports,p),p.exports);var Y=(D,p,B)=>new Promise((x,j)=>{var C=i=>{try{u(B.next(i))}catch(w){j(w)}},e=i=>{try{u(B.throw(i))}catch(w){j(w)}},u=i=>i.done?x(i.value):Promise.resolve(i.value).then(C,e);u((B=B.apply(D,p)).next())});var co=go((bo,R)=>{(function(){"use strict";let D="2.3.3",p=null,B="",x="",j={init:C};function C(){return Y(this,arguments,function*(o={}){if(typeof o=="string"&&(o={key:o}),p=o.key||o.widgetKey,!p){console.error("[Klyro] Missing widget key in initKlyro");return}B=o.apiBase||"https://klyro-pro.vercel.app",x=`klyro_${p}`,console.log("[Klyro] Initializing with version:",D),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",K):K()})}let e=null,u=!1,i=[],w=null,v=!1,f=null,F=null,N=!1,E=!1;function Z(){try{let o=localStorage.getItem(x);if(o){let r=JSON.parse(o);return i=r.messages||[],w=r.sessionId||null,console.log("[Klyro] Loaded persisted chat:",i.length,"messages"),!0}}catch(o){console.error("[Klyro] Failed to load persisted chat:",o)}return!1}function L(){try{let o={messages:i,sessionId:w,lastUpdated:new Date().toISOString()};localStorage.setItem(x,JSON.stringify(o))}catch(o){console.error("[Klyro] Failed to persist chat:",o)}}function q(){try{localStorage.removeItem(x)}catch(o){console.error("[Klyro] Failed to clear persisted chat:",o)}}function O(){if(i.length===0)return;let o=(e==null?void 0:e.headerTitle)||"Chat Transcript",r=new Date().toLocaleString(),t=`${o}
`;t+=`Downloaded: ${r}
`,t+="=".repeat(50)+`

`,i.forEach((h,d)=>{let l=h.role==="user"?"You":(e==null?void 0:e.headerTitle)||"Assistant";t+=`${l}:
${h.content}

`});let n=new Blob([t],{type:"text/plain"}),a=URL.createObjectURL(n),g=document.createElement("a");g.href=a,g.download=`chat-transcript-${new Date().toISOString().split("T")[0]}.txt`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(a)}let V=`
    .klyro-widget * {
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
...
</svg>`;function X(o){if(!o||o.length===0)return!0;let r=window.location.pathname;for(let t of o){let n=t.trim();if(n===r)return!0;if(n.endsWith("/*")){let a=n.slice(0,-2);if(r===a||r.startsWith(a+"/"))return!0}if(n==="/"&&r==="/")return!0}return!1}function S(){if(!f||!e)return;let o=window.location.pathname;if(o===F)return;if(F=o,X(e.allowedRoutes))f.style.display="",console.log("[Klyro] Widget shown on route:",o);else{if(f.style.display="none",u){u=!1;let t=f.querySelector(".klyro-panel");t&&t.classList.remove("open")}console.log("[Klyro] Widget hidden on route:",o)}}function ro(){F=window.location.pathname,window.addEventListener("popstate",()=>{console.log("[Klyro] Popstate detected"),S()});let o=history.pushState;history.pushState=function(...t){o.apply(this,t),console.log("[Klyro] PushState detected"),setTimeout(S,0)};let r=history.replaceState;history.replaceState=function(...t){r.apply(this,t),console.log("[Klyro] ReplaceState detected"),setTimeout(S,0)},console.log("[Klyro] Route change listeners set up")}function K(){return Y(this,null,function*(){console.log("[Klyro] Initializing, API_BASE:",B);try{let o=`${B}/api/widget/${p}`;console.log("[Klyro] Fetching config from:",o);let r=yield fetch(o);if(console.log("[Klyro] Response status:",r.status),!r.ok)throw new Error("Widget not found");e=yield r.json(),console.log("[Klyro] Config loaded:",e),Z(),i.length>0&&e.welcomeMessage&&i[0].role==="assistant"&&i[0].content===e.welcomeMessage&&(console.log("[Klyro] Removing legacy welcome message from history"),i.shift(),L()),ao(),ro(),!X(e.allowedRoutes)&&f&&(f.style.display="none",console.log("[Klyro] Widget hidden on initial route:",window.location.pathname))}catch(o){console.error("Klyro: Failed to load widget",o)}})}function ao(){console.log("[Klyro] Rendering widget...");let o=document.createElement("style");o.textContent=V,document.head.appendChild(o);let r=e.theme;r==="auto"&&(r=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");let t=document.createElement("div");t.className=`klyro-widget ${r}`,t.style.setProperty("--primary-color",e.primaryColor);let n=e.launcherMode==="text"&&e.launcherText,a=e.logoUrl?`<img src="${k(e.logoUrl)}" alt="Logo" class="klyro-custom-logo">`:to;t.innerHTML=`
      <button class="klyro-button ${e.position} ${n?"text-mode":""}" style="background: ${e.primaryColor}">
        ${U}
    ...
    `,document.body.appendChild(t),f=t;let g=t.querySelector(".klyro-button"),h=t.querySelector(".klyro-panel"),d=t.querySelector(".klyro-messages"),l=t.querySelector(".klyro-input"),c=t.querySelector(".klyro-send"),b=t.querySelector(".reset-btn"),M=t.querySelector(".klyro-header"),no=t.querySelector(".menu-btn"),Q=t.querySelector(".klyro-menu-popover"),H=t.querySelector(".expand-toggle-btn"),T=t.querySelector(".download-transcript-btn"),G=t.querySelector(".klyro-popover-overlay"),lo=G.querySelector(".confirm"),so=G.querySelector(".cancel");I(),g.addEventListener("click",()=>{u=!u,h.classList.toggle("open",u);let s=e.launcherMode==="text"&&e.launcherText;u?(g.innerHTML=P,g.classList.remove("text-mode"),l.focus(),I()):(g.innerHTML=U+(s?`<span class="klyro-button-text">${k(e.launcherText)}</span>`:""),s&&g.classList.add("text-mode"))}),b.addEventListener("click",()=>{E=!1,Q.classList.remove("open"),G.classList.add("open")}),no.addEventListener("click",s=>{s.stopPropagation(),E=!E,Q.classList.toggle("open",E)}),document.addEventListener("click",()=>{E&&(E=!1,Q.classList.remove("open"))}),H.addEventListener("click",()=>{N=!N,h.classList.toggle("expanded",N);let s=H.querySelector(".klyro-menu-item-icon"),y=H.querySelector(".klyro-menu-item-text");N?(s.innerHTML=eo,y.textContent="Collapse window"):(s.innerHTML=J,y.textContent="Expand window"),E=!1,Q.classList.remove("open")}),T.addEventListener("click",()=>{O(),E=!1,Q.classList.remove("open")}),so.addEventListener("click",()=>{G.classList.remove("open")}),lo.addEventListener("click",()=>{i=[],w=null,q(),I(),G.classList.remove("open")});function W(s){return Y(this,null,function*(){let y=s||l.value.trim();if(!(!y||v)){i.push({role:"user",content:y}),s||(l.value=""),I(),L(),v=!0,I();try{let A=yield fetch(`${B}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:y,widgetKey:p,sessionId:w})}),m=yield A.json();v=!1,A.ok?(w=m.sessionId,i.push({role:"assistant",content:m.response}),L()):i.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}catch(A){v=!1,i.push({role:"assistant",content:"Unable to connect. Please try again later."})}I()}})}c.addEventListener("click",()=>W()),l.addEventListener("keypress",s=>{s.key==="Enter"&&W()});function I(){let s=i.filter((A,m)=>!(m===0&&A.role==="assistant"&&e.welcomeMessage&&A.content.trim()===e.welcomeMessage.trim()));s.length>0?M.classList.add("chat-active"):M.classList.remove("chat-active"),T.disabled=s.length===0,s.length===0?d.innerHTML=`
        ...
        `:d.innerHTML=s.map(A=>`
          <div class="klyro-message ${A.role}" ${A.role==="user"?`style="background: ${e.primaryColor}"`:""}>
            ${A.role==="assistant"?io(A.content):k(A.content)}
          </div>
        `).join(""),v&&(d.innerHTML+=`
        ...
        `);let y=s;if(!v&&y.length>0)if(y[y.length-1].role==="assistant"){let m=d.lastElementChild;m&&(d.scrollTop=m.offsetTop-20)}else d.scrollTop=d.scrollHeight;else d.scrollTop=d.scrollHeight;c.disabled=v}}function io(o){if(!o)return"";console.log("[Klyro] formatMessage called with:",o.substring(0,100));let r=[],t=o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g,(l,c,b)=>{let M=`__LINK_${r.length}__`;return r.push({text:c,url:b}),M}),n=[];t=t.replace(/(https?:\/\/[^\s<\]]+)/g,(l,c)=>{if(l.includes("__LINK_"))return l;console.log("[Klyro] Found raw URL:",c);let b=`__URL_${n.length}__`;return n.push(c),b});let a=k(t);r.forEach((l,c)=>{let b=k(l.text);a=a.replace(`__LINK_${c}__`,`<a href="${l.url}" target="_blank" rel="noopener noreferrer">${b}</a>`)}),n.forEach((l,c)=>{a=a.replace(`__URL_${c}__`,`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`)}),a=a.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),a=a.replace(new RegExp("(?<!^|\\n)\\*([^*\\n]+)\\*","g"),"<em>$1</em>");let g=a.split(`
`),h=!1,d=[];for(let l=0;l<g.length;l++){let c=g[l],b=c.match(/^[\s]*[•\-\*]\s+(.+)$/);b?(h||(d.push("<ul>"),h=!0),d.push(`<li>${b[1]}</li>`)):(h&&(d.push("</ul>"),h=!1),d.push(c))}return h&&d.push("</ul>"),a=d.join(`
`),a=a.replace(/\n(?!<\/?[uo]l|<\/?li)/g,"<br>"),a=a.replace(/\n/g,""),console.log("[Klyro] formatMessage result:",a.substring(0,100)),a}function k(o){if(typeof document=="undefined")return o;let r=document.createElement("div");return r.textContent=o,r.innerHTML}if(typeof document!="undefined"){let o=document.currentScript;if(o){let r=o.getAttribute("data-widget-key"),t=o.getAttribute("data-api-base");if(r){let n=t;if(!n&&o.src)try{let a=new URL(o.src);!a.hostname.includes("unpkg.com")&&!a.hostname.includes("jsdelivr.net")&&(n=a.origin)}catch(a){n=o.src.replace("/widget.js",""),(n==="widget.js"||n==="")&&(n=window.location.origin)}C({key:r,apiBase:n})}}}typeof R!="undefined"&&R.exports?R.exports={initKlyro:C}:window.initKlyro=C})()});co();})();
