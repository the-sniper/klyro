  ...
  var Y = (C, p, y) =>
    new Promise((v, R) => {
      var f = (i) => {
        ...
        u = (i) => (i.done ? v(i.value) : Promise.resolve(i.value).then(f, e));
      u((y = y.apply(C, p)).next());
    });
  var Ao = go((bo, M) => {
    (function () {
      "use strict";
      let C = "2.3.2",
        ...
        R = { init: f };
      function f() {
        return Y(this, arguments, function* (o = {}) {
          if (
            (typeof o == "string" && (o = { key: o }),
            (p = o.key || o.widgetKey),
            !p)
          ) {
          ...
          ((y = o.apiBase || "https://klyro-pro.vercel.app"),
            (v = `klyro_${p}`),
            console.log("[Klyro] Initializing with version:", C),
...
`;
        ...
        let A = new Blob([t], { type: "text/plain" }),
  ...
  `,
        ...
        to = `<svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<image id="image0_60_92" width="400" height="400" preserveAspectRatio="none" xlink:href="data:image/png;base64,"/>
      ...
      function L() {
        ...
        if (o === j) return;
        if (((j = o), J(e.allowedRoutes)))
          ((E.style.display = ""),
            console.log("[Klyro] Widget shown on route:", o));
        else {
          if (((E.style.display = "none"), u)) {
            u = !1;
            let t = E.querySelector(".klyro-panel");
      ...
      function ro() {
        ((j = window.location.pathname),
          window.addEventListener("popstate", () => {
            (console.log("[Klyro] Popstate detected"), L());
          }));
      ...
      function X() {
        return Y(this, null, function* () {
          console.log("[Klyro] Initializing, API_BASE:", y);
          try {
            let o = `${y}/api/widget/${p}`;
      ...
      function ao() {
        ...
        ((o.textContent = V), document.head.appendChild(o));
        let r = e.theme;
        r === "auto" &&
        ...
        let A = e.launcherMode === "text" && e.launcherText,
          a = e.logoUrl
            ? `<img src="${w(e.logoUrl)}" alt="Logo" class="klyro-custom-logo">`
            : to;
        ((t.innerHTML = `
    ...
    `),
        ...
        let d = t.querySelector(".klyro-button"),
          ...
          c = t.querySelector(".klyro-messages"),
          n = t.querySelector(".klyro-input"),
          g = t.querySelector(".klyro-send"),
          b = t.querySelector(".reset-btn"),
          N = t.querySelector(".klyro-header"),
          no = t.querySelector(".menu-btn"),
          I = t.querySelector(".klyro-menu-popover"),
          S = t.querySelector(".expand-toggle-btn"),
          K = t.querySelector(".download-transcript-btn"),
          Q = t.querySelector(".klyro-popover-overlay"),
          lo = Q.querySelector(".confirm"),
          so = Q.querySelector(".cancel");
        (m(),
          d.addEventListener("click", () => {
            ((u = !u), h.classList.toggle("open", u));
            let l = e.launcherMode === "text" && e.launcherText;
            u
              ? ((d.innerHTML = P),
          ...
          b.addEventListener("click", () => {
            ((k = !1), I.classList.remove("open"), Q.classList.add("open"));
          }),
          no.addEventListener("click", (l) => {
            (l.stopPropagation(), (k = !k), I.classList.toggle("open", k));
          }),
          document.addEventListener("click", () => {
            k && ((k = !1), I.classList.remove("open"));
          }),
          S.addEventListener("click", () => {
            ((G = !G), h.classList.toggle("expanded", G));
            let l = S.querySelector(".klyro-menu-item-icon"),
              s = S.querySelector(".klyro-menu-item-text");
            (G
              ? ((l.innerHTML = eo), (s.textContent = "Collapse window"))
              : ((l.innerHTML = U), (s.textContent = "Expand window")),
              (k = !1),
              I.classList.remove("open"));
          }),
          K.addEventListener("click", () => {
            (O(), (k = !1), I.classList.remove("open"));
          }),
          so.addEventListener("click", () => {
            Q.classList.remove("open");
          }),
          lo.addEventListener("click", () => {
            ((i = []), (B = null), q(), m(), Q.classList.remove("open"));
          }));
        function T(l) {
          return Y(this, null, function* () {
            let s = l || n.value.trim();
            if (!(!s || x)) {
              (i.push({ role: "user", content: s }),
                l || (n.value = ""),
                m(),
                F(),
                (x = !0),
              ...
              try {
                ...
                ((x = !1),
                  D.ok
                    ? ((B = W.sessionId),
                      i.push({ role: "assistant", content: W.response }),
                      F())
                    : i.push({
                        role: "assistant",
                        content:
          ...
          let l = i.filter(
            (s, D) =>
              !(
                ...
                s.role === "assistant" &&
                e.welcomeMessage &&
                s.content.trim() === e.welcomeMessage.trim()
              ),
          );
          (l.length > 0
            ? N.classList.add("chat-active")
            : N.classList.remove("chat-active"),
            (K.disabled = l.length === 0),
            l.length === 0
              ? (c.innerHTML = `
      ...
      function io(o) {
        ...
        let r = [],
          t = o.replace(/\[([^\]]+)\]\((https?:\/\/[^\)]+)\)/g, (n, g, b) => {
            let N = `__LINK_${r.length}__`;
            return (r.push({ text: g, url: b }), N);
          }),
          A = [];
        t = t.replace(/(https?:\/\/[^\s<\]]+)/g, (n, g) => {
          if (n.includes("__LINK_")) return n;
          console.log("[Klyro] Found raw URL:", g);
          let b = `__URL_${A.length}__`;
          return (A.push(g), b);
        });
        let a = w(t);
        (r.forEach((n, g) => {
          ...
          a = a.replace(
            `__LINK_${g}__`,
            `<a href="${n.url}" target="_blank" rel="noopener noreferrer">${b}</a>`,
          );
        }),
          A.forEach((n, g) => {
            a = a.replace(
...
`),
        ...
        for (let n = 0; n < d.length; n++) {
          let g = d[n],
            b = g.match(/^[\s]*[•\-\*]\s+(.+)$/);
          b
            ? (h || (c.push("<ul>"), (h = !0)), c.push(`<li>${b[1]}</li>`))
            : (h && (c.push("</ul>"), (h = !1)), c.push(g));
        }
        return (
          h && c.push("</ul>"),
          (a = c.join(`
`)),
      ...
      function w(o) {
        ...
        return ((r.textContent = o), r.innerHTML);
      }
      if (typeof document != "undefined") {
        let o = document.currentScript;
        if (o) {
          let r = o.getAttribute("data-widget-key");
          r && f({ key: r, apiBase: o.src.replace("/widget.js", "") });
        }
      }
      typeof M != "undefined" && M.exports
        ? (M.exports = { initKlyro: f })
        : (window.initKlyro = f);
    })();
  });
  Ao();
